...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { courseDeptRating: @university.courseDeptRating, disabilityDeptRating: @university.disabilityDeptRating, disabilityURL: @university.disabilityURL, name: @university.name, url: @university.url }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { courseDeptRating: @university.courseDeptRating, disabilityDeptRating: @university.disabilityDeptRating, disabilityURL: @university.disabilityURL, name: @university.name, url: @university.url }
    assert_redirected_to university_path(assigns(:university))
  end
